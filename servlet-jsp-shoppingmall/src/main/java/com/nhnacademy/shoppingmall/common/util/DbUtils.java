...
public class DbUtils {
    ...
    static {
        ...
        basicDataSource.setUrl("jdbc:mysql://133.186.241.167:3306/nhn_academy_29");
        basicDataSource.setUsername("nhn_academy_29");
        basicDataSource.setPassword("O8jJitFThm]dssG4");
